...
If you want to modify your existing Nuxt app to efficiently run on Zerops, there are no changes needed in the codebase on top of the standard installation, just add [zerops.yml](https://github.com/zeropsio/recipe-nuxt-static/blob/main/zerops.yml) to your repository.
